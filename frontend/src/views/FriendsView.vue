    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="main-center col-span-2 space-y-4">
            ...
            >
                ...
                <div v-for="friendshipRequest in friendshipRequests" v-bind:key="friendshipRequest.id" class="p-4 text-center bg-gray-100 rounded-lg">
                    <img :src="friendshipRequest.get_avatar" class="mb-6 mx-auto rounded-full">
